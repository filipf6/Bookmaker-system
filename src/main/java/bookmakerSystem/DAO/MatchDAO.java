...
public class MatchDAO
{
	public static ArrayList<Match>getMatches(LocalDate matchDate)
	{
		...
		ResultSet rs=DatabaseConnector.getResultStatement("select id_meczu from mecz where data_meczu='"+matchDate+"'");
		...
		try
		{
			...
			{
				rs=DatabaseConnector.getResultStatement("select k1.nazwa_klubu, k1.data_zalozenia, k1.stadion, k2.nazwa_klubu, k2.data_zalozenia, k2.stadion, m.godzina_rozpoczecia, m.numer_kolejki, m.kurs_zwyciestwo_gospodarza,m.kurs_remis,m.kurs_zwyciestwo_goscia "
